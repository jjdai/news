<?php
// $Id: functions.php 9767 2012-07-02 06:02:52Z beckmi $
//  ------------------------------------------------------------------------ //
...
{
	require_once XOOPS_ROOT_PATH.'/modules/news/class/wideimage/WideImage.inc.php';
	$resize = true;
...
/****************************************************************
 *  Transformation de la date fr en en 
 ****************************************************************/
