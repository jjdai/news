<?php
// $Id: xoops_version.php 9767 2012-07-02 06:02:52Z beckmi $
//  ------------------------------------------------------------------------ //
...
$modversion['credits'] = "The XOOPS Project, Christian, Pilou, Marco, <br />ALL the members of the Newbb Team, GIJOE, Zoullou, Mithrandir, <br />Setec Astronomy, Marcan, 5vision, Anne, Trabis, dhsoft, Mamba, Mage, Timgno";
...
$modversion["release_date"] = "2012/07/12";
...
// Templates
$i = 1;
$modversion['templates'][$i]['file'] = 'news_item.html';
$modversion['templates'][$i]['description'] = '';
$i++;
$modversion['templates'][$i]['file'] = 'news_archive.html';
$modversion['templates'][$i]['description'] = '';
$i++;
$modversion['templates'][$i]['file'] = 'news_article.html';
$modversion['templates'][$i]['description'] = '';
$i++;
$modversion['templates'][$i]['file'] = 'news_index.html';
$modversion['templates'][$i]['description'] = '';
$i++;
$modversion['templates'][$i]['file'] = 'news_by_topic.html';
$modversion['templates'][$i]['description'] = '';
$i++;
$modversion['templates'][$i]['file'] = 'news_by_this_author.html';
$modversion['templates'][$i]['description'] = 'Shows a page resuming all the articles of the same author (according to the perms)';
$i++;
$modversion['templates'][$i]['file'] = 'news_ratenews.html';
$modversion['templates'][$i]['description'] = 'Template used to rate a news';
$i++;
$modversion['templates'][$i]['file'] = 'news_rss.html';
$modversion['templates'][$i]['description'] = 'Used for RSS per topics';
$i++;
$modversion['templates'][$i]['file'] = 'news_whos_who.html';
$modversion['templates'][$i]['description'] = "Who's who";
$i++;
$modversion['templates'][$i]['file'] = 'news_topics_directory.html';
...
$modversion['config'][$i]['options'] = array('_MI_UPLOAD_GROUP1' => 1, '_MI_UPLOAD_GROUP2' => 2, '_MI_UPLOAD_GROUP3' => 3);
